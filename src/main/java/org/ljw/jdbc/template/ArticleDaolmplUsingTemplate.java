...
import org.ljw.jdbc.raw.Article;
import org.ljw.jdbc.raw.ArticleDao;
 ...
 * @author Jacob
 */
public class ArticleDaolmplUsingTemplate implements ArticleDao {
	/**
	 * 목록 가져오는 sql
	 */
	 ...
	 */
	public ArticleDaolmplUsingTemplate() {
		dataSource = new MariaDbDataSource(
				"jdbc:mariadb://localhost:3306/jwdb?user=jw&password=2515");
